 ...
 * </p>
 * <ul>
 *   <li>{@link rpg_modeling.impl.WizardImpl#getSkill <em>Skill</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WizardImpl extends JobImpl implements Wizard {
  /**
  ...
  protected EClass eStaticClass() {
    return Rpg_modelingPackage.Literals.WIZARD;
  }
  ...
  public void setSkill(EList newSkill) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Rpg_modelingPackage.WIZARD__SKILL, oldSkill, skill));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      case Rpg_modelingPackage.WIZARD__SKILL:
        return getSkill();
    }
