 ...
 * </p>
 * <ul>
 *   <li>{@link rpg_modeling.Wizard#getSkill <em>Skill</em>}</li>
 * </ul>
 *
 * @see rpg_modeling.Rpg_modelingPackage#getWizard()
 * @model
 * @generated
 */
public interface Wizard extends Job {
  /**
   ...
   * @see #setSkill(EList)
   * @see rpg_modeling.Rpg_modelingPackage#getWizard_Skill()
  ...
  /**
   * Sets the value of the '{@link rpg_modeling.Wizard#getSkill <em>Skill</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
